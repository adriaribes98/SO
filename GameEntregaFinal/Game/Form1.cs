...
namespace Game
{
    public partial class Form1 : Form
    {
            ...
            while (true)
            {
                ...
                switch (codigo)
                {
                    ...
                    case 9:
                        ...
                        textBox5.Text = (trozos2[3] + " te ha invitado a jugar una partida");
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            button10.Enabled = true;
            string chatid = "12/" + textBox2.Text + Usuarioinvitado;
            byte[] msg = System.Text.Encoding.ASCII.GetBytes(chatid);
            servidor.Send(msg);
            byte[] msg2 = new byte[500];
        ...
        private void button10_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                servidor.Send(msg);
                byte[] msg2 = new byte[500];
                listBox1.Items.Add("Yo: " + textBox8.Text);
                textBox8.Text = "";
            }
            catch
            {
